...
// DISPLAY RESULT2
// SP
document.getElementById('sp_n1d').innerHTML = spn1
document.getElementById('sp_n2d').innerHTML = spn2
document.getElementById('sp_n3d').innerHTML = spn3
document.getElementById('sp_n4d').innerHTML = spn4
document.getElementById('sp_n5d').innerHTML = spn5
document.getElementById('sp_n6d').innerHTML = spn6
document.getElementById('sp_n7d').innerHTML = spn7
document.getElementById('sp_n8d').innerHTML = spn8
document.getElementById('sp_n9d').innerHTML = spn9
document.getElementById('sp_n10d').innerHTML = spn10

document.getElementById('sp_rn1d').innerHTML = sprn1
document.getElementById('sp_rn2d').innerHTML = sprn2
document.getElementById('sp_rn3d').innerHTML = sprn3
document.getElementById('sp_rn4d').innerHTML = sprn4
document.getElementById('sp_rn5d').innerHTML = sprn5
document.getElementById('sp_rn6d').innerHTML = sprn6
document.getElementById('sp_rn7d').innerHTML = sprn7
document.getElementById('sp_rn8d').innerHTML = sprn8
document.getElementById('sp_rn9d').innerHTML = sprn9
document.getElementById('sp_rn10d').innerHTML = sprn10

document.getElementById("sp_dplct1d").innerHTML = spdplct1
document.getElementById("sp_dplct2d").innerHTML = spdplct2
document.getElementById("sp_dplct3d").innerHTML = spdplct3
document.getElementById("sp_dplct4d").innerHTML = spdplct4
document.getElementById("sp_dplct5d").innerHTML = spdplct5
document.getElementById("sp_dplct6d").innerHTML = spdplct6
document.getElementById("sp_dplct7d").innerHTML = spdplct7
document.getElementById("sp_dplct8d").innerHTML = spdplct8
document.getElementById("sp_dplct9d").innerHTML = spdplct9
document.getElementById("sp_dplct10d").innerHTML = spdplct10
// DL
document.getElementById('dl_n1d').innerHTML = dln1
document.getElementById('dl_n2d').innerHTML = dln2
document.getElementById('dl_n3d').innerHTML = dln3
document.getElementById('dl_n4d').innerHTML = dln4
document.getElementById('dl_n5d').innerHTML = dln5
document.getElementById('dl_n6d').innerHTML = dln6
document.getElementById('dl_n7d').innerHTML = dln7
document.getElementById('dl_n8d').innerHTML = dln8
document.getElementById('dl_n9d').innerHTML = dln9
document.getElementById('dl_n10d').innerHTML = dln10

document.getElementById('dl_rn1d').innerHTML = dlrn1
document.getElementById('dl_rn2d').innerHTML = dlrn2
document.getElementById('dl_rn3d').innerHTML = dlrn3
document.getElementById('dl_rn4d').innerHTML = dlrn4
document.getElementById('dl_rn5d').innerHTML = dlrn5
document.getElementById('dl_rn6d').innerHTML = dlrn6
document.getElementById('dl_rn7d').innerHTML = dlrn7
document.getElementById('dl_rn8d').innerHTML = dlrn8
document.getElementById('dl_rn9d').innerHTML = dlrn9
document.getElementById('dl_rn10d').innerHTML = dlrn10

document.getElementById('dl_dplct1d').innerHTML = dldplct1
document.getElementById('dl_dplct2d').innerHTML = dldplct2
document.getElementById('dl_dplct3d').innerHTML = dldplct3
document.getElementById('dl_dplct4d').innerHTML = dldplct4
document.getElementById('dl_dplct5d').innerHTML = dldplct5
document.getElementById('dl_dplct6d').innerHTML = dldplct6
document.getElementById('dl_dplct7d').innerHTML = dldplct7
document.getElementById('dl_dplct8d').innerHTML = dldplct8
document.getElementById('dl_dplct9d').innerHTML = dldplct9
document.getElementById('dl_dplct10d').innerHTML = dldplct10

document.getElementById('dl_rr1d').innerHTML = dlrr1
document.getElementById('dl_rr2d').innerHTML = dlrr2
document.getElementById('dl_rr3d').innerHTML = dlrr3
document.getElementById('dl_rr4d').innerHTML = dlrr4
document.getElementById('dl_rr5d').innerHTML = dlrr5
document.getElementById('dl_rr6d').innerHTML = dlrr6
document.getElementById('dl_rr7d').innerHTML = dlrr7
document.getElementById('dl_rr8d').innerHTML = dlrr8
document.getElementById('dl_rr9d').innerHTML = dlrr9
document.getElementById('dl_rr10d').innerHTML = dlrr10

document.getElementById('dl_othrs1d').innerHTML = dlothrs1
document.getElementById('dl_othrs2d').innerHTML = dlothrs2
document.getElementById('dl_othrs3d').innerHTML = dlothrs3
document.getElementById('dl_othrs4d').innerHTML = dlothrs4
document.getElementById('dl_othrs5d').innerHTML = dlothrs5
document.getElementById('dl_othrs6d').innerHTML = dlothrs6
document.getElementById('dl_othrs7d').innerHTML = dlothrs7
document.getElementById('dl_othrs8d').innerHTML = dlothrs8
document.getElementById('dl_othrs9d').innerHTML = dlothrs9
document.getElementById('dl_othrs10d').innerHTML = dlothrs10
// CL
document.getElementById('cl_n1d').innerHTML = cln1
document.getElementById('cl_n2d').innerHTML = cln2
document.getElementById('cl_n3d').innerHTML = cln3
document.getElementById('cl_n4d').innerHTML = cln4
document.getElementById('cl_n5d').innerHTML = cln5
document.getElementById('cl_n6d').innerHTML = cln6
document.getElementById('cl_n7d').innerHTML = cln7
document.getElementById('cl_n8d').innerHTML = cln8
document.getElementById('cl_n9d').innerHTML = cln9
document.getElementById('cl_n10d').innerHTML = cln10

document.getElementById('cl_rn1d').innerHTML = clrn1
document.getElementById('cl_rn2d').innerHTML = clrn2
document.getElementById('cl_rn3d').innerHTML = clrn3
document.getElementById('cl_rn4d').innerHTML = clrn4
document.getElementById('cl_rn5d').innerHTML = clrn5
document.getElementById('cl_rn6d').innerHTML = clrn6
document.getElementById('cl_rn7d').innerHTML = clrn7
document.getElementById('cl_rn8d').innerHTML = clrn8
document.getElementById('cl_rn9d').innerHTML = clrn9
document.getElementById('cl_rn10d').innerHTML = clrn10

document.getElementById('cl_dplct1d').innerHTML = cldplct1
document.getElementById('cl_dplct2d').innerHTML = cldplct2
document.getElementById('cl_dplct3d').innerHTML = cldplct3
document.getElementById('cl_dplct4d').innerHTML = cldplct4
document.getElementById('cl_dplct5d').innerHTML = cldplct5
document.getElementById('cl_dplct6d').innerHTML = cldplct6
document.getElementById('cl_dplct7d').innerHTML = cldplct7
document.getElementById('cl_dplct8d').innerHTML = cldplct8
document.getElementById('cl_dplct9d').innerHTML = cldplct9
document.getElementById('cl_dplct10d').innerHTML = cldplct10

document.getElementById('cl_rr1d').innerHTML = clrr1
document.getElementById('cl_rr2d').innerHTML = clrr2
document.getElementById('cl_rr3d').innerHTML = clrr3
document.getElementById('cl_rr4d').innerHTML = clrr4
document.getElementById('cl_rr5d').innerHTML = clrr5
document.getElementById('cl_rr6d').innerHTML = clrr6
document.getElementById('cl_rr7d').innerHTML = clrr7
document.getElementById('cl_rr8d').innerHTML = clrr8
document.getElementById('cl_rr9d').innerHTML = clrr9
document.getElementById('cl_rr10d').innerHTML = clrr10

document.getElementById('cl_othrs1d').innerHTML = clothrs1
document.getElementById('cl_othrs2d').innerHTML = clothrs2
document.getElementById('cl_othrs3d').innerHTML = clothrs3
document.getElementById('cl_othrs4d').innerHTML = clothrs4
document.getElementById('cl_othrs5d').innerHTML = clothrs5
document.getElementById('cl_othrs6d').innerHTML = clothrs6
document.getElementById('cl_othrs7d').innerHTML = clothrs7
document.getElementById('cl_othrs8d').innerHTML = clothrs8
document.getElementById('cl_othrs9d').innerHTML = clothrs9
document.getElementById('cl_othrs10d').innerHTML = clothrs10

// TOTAL 
document.getElementById('sp_ttl1d').innerHTML = spn1 + sprn1 + spdplct1
document.getElementById('sp_ttl2d').innerHTML = spn2 + sprn2 + spdplct2
document.getElementById('sp_ttl3d').innerHTML = spn3 + sprn3 + spdplct3
document.getElementById('sp_ttl4d').innerHTML = spn4 + sprn4 + spdplct4
document.getElementById('sp_ttl5d').innerHTML = spn5 + sprn5 + spdplct5
document.getElementById('sp_ttl6d').innerHTML = spn6 + sprn6 + spdplct6
document.getElementById('sp_ttl7d').innerHTML = spn7 + sprn7 + spdplct7
document.getElementById('sp_ttl8d').innerHTML = spn8 + sprn8 + spdplct8
document.getElementById('sp_ttl9d').innerHTML = spn9 + sprn9 + spdplct9
document.getElementById('sp_ttl10d').innerHTML = spn10 + sprn10 + spdplct10

document.getElementById('dl_ttl1d').innerHTML = dln1 + dlrn1 + dldplct1 + dlrr1 + dlothrs1
document.getElementById('dl_ttl2d').innerHTML = dln2 + dlrn2 + dldplct2 + dlrr2 + dlothrs2
document.getElementById('dl_ttl3d').innerHTML = dln3 + dlrn3 + dldplct3 + dlrr3 + dlothrs3
document.getElementById('dl_ttl4d').innerHTML = dln4 + dlrn4 + dldplct4 + dlrr4 + dlothrs4
document.getElementById('dl_ttl5d').innerHTML = dln5 + dlrn5 + dldplct5 + dlrr5 + dlothrs5
document.getElementById('dl_ttl6d').innerHTML = dln6 + dlrn6 + dldplct6 + dlrr6 + dlothrs6
document.getElementById('dl_ttl7d').innerHTML = dln7 + dlrn7 + dldplct7 + dlrr7 + dlothrs7
document.getElementById('dl_ttl8d').innerHTML = dln8 + dlrn8 + dldplct8 + dlrr8 + dlothrs8
document.getElementById('dl_ttl9d').innerHTML = dln9 + dlrn9 + dldplct9 + dlrr9 + dlothrs9
document.getElementById('dl_ttl10d').innerHTML = dln10 + dlrn10 + dldplct10 + dlrr10 + dlothrs10

document.getElementById('cl_ttl1d').innerHTML = cln1 + clrn1 + cldplct1 + clrr1 + clothrs1
document.getElementById('cl_ttl2d').innerHTML = cln2 + clrn2 + cldplct2 + clrr2 + clothrs2
document.getElementById('cl_ttl3d').innerHTML = cln3 + clrn3 + cldplct3 + clrr3 + clothrs3
document.getElementById('cl_ttl4d').innerHTML = cln4 + clrn4 + cldplct4 + clrr4 + clothrs4
document.getElementById('cl_ttl5d').innerHTML = cln5 + clrn5 + cldplct5 + clrr5 + clothrs5
document.getElementById('cl_ttl6d').innerHTML = cln6 + clrn6 + cldplct6 + clrr6 + clothrs6
document.getElementById('cl_ttl7d').innerHTML = cln7 + clrn7 + cldplct7 + clrr7 + clothrs7
document.getElementById('cl_ttl8d').innerHTML = cln8 + clrn8 + cldplct8 + clrr8 + clothrs8
document.getElementById('cl_ttl9d').innerHTML = cln9 + clrn9 + cldplct9 + clrr9 + clothrs9
document.getElementById('cl_ttl10d').innerHTML = cln10 + clrn10 + cldplct10 + clrr10 + clothrs10

document.getElementById('ttl1d').innerHTML = ttlall1
document.getElementById('ttl2d').innerHTML = ttlall2
document.getElementById('ttl3d').innerHTML = ttlall3
document.getElementById('ttl4d').innerHTML = ttlall4
document.getElementById('ttl5d').innerHTML = ttlall5
document.getElementById('ttl6d').innerHTML = ttlall6
document.getElementById('ttl7d').innerHTML = ttlall7
document.getElementById('ttl8d').innerHTML = ttlall8
document.getElementById('ttl9d').innerHTML = ttlall9
document.getElementById('ttl10d').innerHTML = ttlall10

// TOTAL OF ALL
document.getElementById('ttlal1d').innerHTML = sp1
document.getElementById('ttlal2d').innerHTML = sp2
document.getElementById('ttlal3d').innerHTML = sp3
document.getElementById('ttlal4d').innerHTML = sp1 + sp2 + sp3
document.getElementById('ttlal5d').innerHTML = dl1
document.getElementById('ttlal6d').innerHTML = dl2
document.getElementById('ttlal7d').innerHTML = dl3
document.getElementById('ttlal8d').innerHTML = dl4
document.getElementById('ttlal9d').innerHTML = dl5
document.getElementById('ttlal10d').innerHTML = dl1 + dl2 + dl3 + dl4 + dl5
document.getElementById('ttlal11d').innerHTML = cl1
document.getElementById('ttlal12d').innerHTML = cl2
document.getElementById('ttlal13d').innerHTML = cl3
document.getElementById('ttlal14d').innerHTML = cl4
document.getElementById('ttlal15d').innerHTML = cl5
document.getElementById('ttlal16d').innerHTML = cl1 + cl2 + cl3 + cl4 + cl5
document.getElementById('ttlal17d').innerHTML = ttlall1+ttlall2+ttlall3+ttlall4+ttlall5+ttlall6+ttlall7+ttlall8+ttlall9+ttlall10
