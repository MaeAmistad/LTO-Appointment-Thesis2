...
document.getElementById('dte').addEventListener('change', (e) => {
    ...
    localStorage.setItem('chngeDtIN',changeDate)
});
// GET DATA FROM LOCALSTORAGE
srchdate.addEventListener('click',() => {
    localStorage.getItem('chngeDtIN')
...
document.getElementById("dte").value = localStorage.getItem('chngeDtIN');

var changeDate = localStorage.getItem('chngeDtIN')
